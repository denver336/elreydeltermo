...
jQuery(document).ready(function ($) {
  ...
  $(".callback").fancybox({
    ...
    tpl: {
      closeBtn:
        '<a title="Close" class="fancybox-item fancybox-close modal-form-close" href="javascript:;"></a>',
    },
  });
  ...
  $(".fancy-img").fancybox({
    ...
    tpl: {
      closeBtn:
        '<a title="Close" class="fancybox-item fancybox-close modal-form-close2" href="javascript:;"></a>',
  ...
  // Filter Button
  if (
    $("#section-filter-toggle-btn").length > 0 &&
    $(".section-filter .woof_redraw_zone").length > 0
  ) {
    $(".section-filter-toggle").on(
      "click",
      "#section-filter-toggle-btn",
      function () {
        var $this = $(this),
        ...
        if ($btn_wrap.hasClass("filter_hidden")) {
          ...
          document.cookie =
            "filter_toggle=filter_opened; expires=Thu, 31 Dec 2020 23:59:59 GMT; path=/;";
        } else {
          $this.text($this.data("showtext"));
          $btn_wrap.addClass("filter_hidden");
          document.cookie =
            "filter_toggle=filter_hidden; expires=Thu, 31 Dec 2020 23:59:59 GMT; path=/;";
        }
  ...
  $("body").on("click", ".prod-tabs li a", function () {
    var $this = $(this),
      ...
      $tabs = $(".prod-tabs li");
    if (
      $this_parent.hasClass("prod-tabs-addreview") ||
      $this_parent.hasClass("active") ||
    ...
    $(
      ".prod-tab-mob[data-prodtab-num=" + $this_parent.data("prodtab-num") + "]"
    ).addClass("active");
  ...
  $("body").on("click", ".prod-tab-cont .prod-tab-mob", function () {
    ...
    $tabs.removeClass("active");
    $(
      ".prod-tabs li[data-prodtab-num=" + $this.data("prodtab-num") + "]"
    ).addClass("active");
...
(function ($) {
  jQuery(window).load(function () {
    ...
    if ($("#prod-slider").length > 0) {
      ...
      $("#prod-slider").on("click", ".prod-slider-zoom", function () {
        $("#prod-slider .slides .flex-active-slide .fancy-img").trigger(
          "click"
        );
        return false;
      });
    ...
    if ($(".header-sticky").length > 0) {
      $(window).scroll(function () {
        ...
        if (
          $site_header_before.length > 0 &&
          $site_header_before.css("display") !== "none"
        ) {
          topbar = true;
        }
        if (topbar) {
          ...
          if (topbar_ht < $(window).scrollTop()) {
            ...
            $site_header_before.css(
              "margin-bottom",
              $site_header_sticky.outerHeight(true)
            );
          } else {
    ...
    if ($(".prod-i").length > 0) {
      $(".prod-i").each(function () {
        ...
        if (
          prod.outerHeight() + 1 <
            prod_img.outerHeight() + prod_cont.outerHeight() ||
          prod.outerHeight() - 1 >
            prod_img.outerHeight() + prod_cont.outerHeight()
        ) {
  ...
  $(".form-validate")
    ...
    .blur(function () {
      if (
        $(this).attr("data-required-email") == "email" &&
        $(this).hasClass("redborder")
      ) {
        if (filterEmail.test($(this).val())) $(this).removeClass("redborder");
        return;
      }
